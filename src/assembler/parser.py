...
from assembler.symbols import tokens
from assembler.symbols import reset_lineno
from assembler.instruction_generation import mcg
from assembler.display import cprint as cp
from assembler.instruction_format import MachineCodeConst
